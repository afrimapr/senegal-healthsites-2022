...
#arrange by city
sfosm_emerg_preg <- arrange(sfosm_emerg_preg, city)

#names(sfosm_emerg_preg)
 # [1] "name_of_facility"    "city"                "phone_number"        "operator_type"      
 # [5] "operational_status"  "facility_category"   "emergency_services"  "number_of_beds"     
 # [9] "number_of_doctors"   "number_of_nurses"    "geometry"            "emergency_pregnancy"
...
write_csv(sfosm_emerg_preg, file="data//emerg-preg-stlouis-osmsurvey.csv")
